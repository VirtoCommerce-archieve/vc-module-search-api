...
"%MSBUILD_PATH%" "%SOURCE_DIR%\VirtoCommerce.SearchApiModule.sln" /nologo /verbosity:m /t:Build /p:Configuration=Release;Platform="Any CPU"

nuget pack "%SOURCE_DIR%\VirtoCommerce.SearchApiModule.Data\VirtoCommerce.SearchApiModule.Data.csproj" -IncludeReferencedProjects -Symbols -Properties Configuration=Release -o "%TARGET_DIR%"
